...
<form id="contactForm" onSubmit="onSubmit(event)" action="<?= base_url('/forget-password'); ?>" method="post"
    ...
    <p class="mb-4 text-grey-700">Masukkan email yang terdaftar</p>
    ...
    <p class="text-sm leading-relaxed text-grey-900">Lupa email ? <a href="/whatsapp-auth"
            class="font-bold text-grey-700">gunakan nomer telepon</a></p>
</form>
<?= $this->endSection() ?>
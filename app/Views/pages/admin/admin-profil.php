...
<h1 class=" p-4 text-stone-600 text-xl"><i class="fa-solid text-xl fa-house mr-4"></i>Profil</h1>
<div class="bg-gray-100 h-screen lg:justify-center lg:flex-row flex-col flex lg:items-start items-center gap-5">
    <div class="bg-white w-[90%] lg:w-[26%] h-auto shadow-md flex items-center flex-col">
        ...
        <img class="w-[280px] mt-4 rounded" src=" <?=base_url('img/' . $admin['foto']);?>" alt="">
        <h1 class="font-bold mt-4 text-gray-400"><?=$admin['nama'];?></h1>

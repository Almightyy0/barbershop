...
<h1 class=" p-4 text-stone-600 text-xl"><i class="fa-solid text-xl fa-house mr-4"></i>Barber</h1>
...
<div class="w-full absolute">
    <div id="dialog"
        class="fixed w-full h-[1200px] top-0 start-0 z-50  bg-black bg-opacity-50 opacity-0 hidden transition-opacity duration-700 ">
        <div class="bg-gray-100 overflow-hidden rounded-md mx-auto h-[600px] w-[600px] mt-8 z-50">
            <div class="overflow-scroll h-[800px]">
                <div class="my-2 ms-4 flex justify-between">
                    <h1 class="text-2xl font-semibold text-green-600 ">Tambah Barber</h1>
                ...
                <div class="bg-white pb-2 mb-[-10px]">
                    <form method="post" enctype="multipart/form-data" action="<?=base_url('/admin/tambah-barber');?>"
                        class=" w-full flex flex-col items-center">
                        <?=csrf_field();?>
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                            <label for="nama">Nama Barber</label>
                        ...
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                            ...
                            <textarea name="alamat" class=" bg-gray-100 rounded h- 12 input input-bordered" required
                                type="date"></textarea>
                        </div>
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                        ...
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                            ...
                            <select name="status" class=" bg-gray-100 rounded h-12 input input-bordered" required>
                        ...
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                            ...
                            <input name="no-wa" class=" bg-gray-100 rounded h-12 input input-bordered" required
                                type="number">
                        </div>
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                            <label for="email">Email</label>
                            <input name="email" class=" bg-gray-100 rounded h-12 input input-bordered" required
                                type="number">
                        </div>

                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                            <label for="password">Pasword</label>
                            <input name="password" class=" bg-gray-100 rounded h-12 input input-bordered" required
                                type="number">
                        </div>
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                            <label for="re-password">Re-Pasword</label>
                            <input name="re-password" class=" bg-gray-100 rounded h-12 input input-bordered" required
                                type="number">
                        </div>
                        ...
                        <div class=" flex flex-col opacity-0 my-2 justify-center w-[95%]">
                            <label for="re-password">Status</label>
                            <select class=" bg-gray-100 rounded h-12 input input-bordered">
                                <option value="aktif">Aktif</option>
                                <option value="tidak-aktif">Tidak Aktif</option>
                        ...
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                            ...
                            <input class=" bg-gray-100 rounded h-12 input input-bordered" type="number">
                        </div>
                    </form>
                </div>
            </div>
...
<div class="w-full absolute">
    <div id="edit-dialog"
        ...
        <div class="bg-gray-100 overflow-hidden rounded-md mx-auto h-[600px] w-[600px] mt-8 z-50">
            <div class="overflow-scroll h-[800px]">
                <div class="my-2 ms-4 flex justify-between">
                    <h1 class="text-2xl font-semibold text-green-600 ">Edit Barber</h1>
                    <i onClick="hideEditBarber()"
                        class="fa-solid ml-12 cursor-pointer text-4xl hover:text-grey-400 text-gray-400 fa-xmark me-3 hover:bg-gray-200 px-2 rounded-lg"></i>
                </div>
                ...
                <div class="bg-white pb-2 mb-[-10px]">
                    <form method="post" enctype="multipart/form-data" action="<?=base_url('/admin/tambah-barber');?>"
                        ...
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                            <label for="foto">Foto</label>
                            <?=isset($error['foto']) ? '<p class="text-start text-red-600 font-sans mb-2 text-sm">' . $error['foto'] . '</p>' : '';?>
                            <input name="foto" class=" bg-gray-100 rounded h-12 file-input input-bordered" required
                                type="file">
                        </div>
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                        ...
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                            <label for="no-wa">No Whatsapp</label>
                            <?=isset($error['wa']) ? '<p class="text-start text-red-600 font-sans mb-2 text-sm">' . $error['wa'] . '</p>' : '';?>
                            <input name="no-wa" class=" bg-gray-100 rounded h-12 input input-bordered" required
                                type="number">
                        </div>
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                        ...
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                            <label for="password">Re-Pasword</label>
                            <?=isset($error['repassword']) ? '<p class="text-start text-red-600 font-sans mb-2 text-sm">' . $error['re-password'] . '</p>' : '';?>
                            <input name="password" class=" bg-gray-100 rounded h-12 input input-bordered" required
                                type="number">
                        </div>
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                            <div class="mt-4 ms-4 flex justify-between">
                                <button class="bg-gray-600 text-white rounded-md px-4 py-2 focus:outline-none"
                                    onClick="hideEditBarber()" type="button">Keluar</button>`
                                <button class="bg-green-600 text-white rounded-md px-4 py-2 focus:outline-none"
                                    type="submit">Simpan</button>
                            </div>
                        </div>
                        <div class=" flex flex-col opacity-0 my-2 justify-center w-[95%]">
                            <label for="re-password">Status</label>
                            <select class=" bg-gray-100 rounded h-12 input input-bordered" required <option
                        ...
                        <div class=" flex flex-col my-2 justify-center w-[95%]">
                            <label for="re-password">Re-Password</label>
                            <input class=" bg-gray-100 rounded h-12 input input-bordered" required type="number">
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="w-full absolute">
        <div id="delete-dialog"
            ...
            <div class="bg-gray-100 overflow-hidden rounded-md mx-auto w-[400px] mt-8 z-50">
                <div class="my-2 ms-4 flex justify-between">
                    <h1 class="text-2xl font-semibold text-green-600 ">Hapus Barber</h1>
                    <i onClick="hideDeleteBarber()"
                        class="fa-solid ml-12 cursor-pointer text-4xl hover:text-grey-400 text-gray-400 fa-xmark me-3 hover:bg-gray-200 px-2 rounded-lg"></i>
                </div>
                ...
                <div class="bg-white pb-2 mb-[-10px]">
                    <form method="post" action="<?=base_url('/admin/delete-layanan');?>"
                        ...
                        <div class=" flex flex-col my-2 items-center justify-center w-[95%]">
                            ...
                            <h1 class="font-semibold text-xl mt-6 text-gray-600">Yakin menghapus Barber ini ?
                            </h1>
                        </div>
                        <div class="mt-4 ms-4 flex justify-between w-[90%]">
                            <button class="bg-blue-600 text-white rounded-md px-4 focus:outline-none py-2"
                                onClick="hideDeleteBarber()" type="button">Keluar</button>`
    ...
    $(document).ready(function() {
        ...
        var table = $('#user-table').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo site_url('admin/barber-server') ?>",
                "type": "POST",
